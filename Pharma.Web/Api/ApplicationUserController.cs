    ...
    public class ApplicationUserController : ApiControllerBase
    {
        ...
        public HttpResponseMessage GetListPaging(HttpRequestMessage request, int page, int pageSize, string filter = null)
        {
            return CreateHttpReponse(request, () =>
            {
                ...
                IEnumerable<ApplicationUserViewModel> modelVm = AutoMapperConfiguration.InitializeAutomapper().Map<IEnumerable<ApplicationUserViewModel>>(model);
        ...
        public HttpResponseMessage Details(HttpRequestMessage request, string id)
        {
            ...
            {
                var applicationUserViewModel = AutoMapperConfiguration.InitializeAutomapper().Map<ApplicationUserViewModel>(user.Result);
                var listGroup = _appGroupService.GetListGroupByUserId(applicationUserViewModel.Id);
                applicationUserViewModel.Groups = AutoMapperConfiguration.InitializeAutomapper().Map<IEnumerable<ApplicationGroupViewModel>>(listGroup);
