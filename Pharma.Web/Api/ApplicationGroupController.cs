    ...
    public class ApplicationGroupController : ApiControllerBase
    {
        ...
        public HttpResponseMessage GetListPaging(HttpRequestMessage request, int page, int pageSize, string filter = null)
        {
            ...
            return CreateHttpReponse(request, () =>
            {
                ...
                IEnumerable<ApplicationGroupViewModel> modelVm = AutoMapperConfiguration.InitializeAutomapper().Map<IEnumerable<ApplicationGroupViewModel>>(model);
        ...
        public HttpResponseMessage Details(HttpRequestMessage request, int id)
        {
            ...
            var appGroupViewModel = AutoMapperConfiguration.InitializeAutomapper().Map<ApplicationGroupViewModel>(appGroup);
            if (appGroup == null)
            {
                return request.CreateErrorResponse(HttpStatusCode.NoContent, "No group");
            }
            var listRole = _appRoleService.GetListRoleByGroupId(appGroupViewModel.ID);
            appGroupViewModel.Roles = AutoMapperConfiguration.InitializeAutomapper().Map<IEnumerable<ApplicationRoleViewModel>>(listRole);
